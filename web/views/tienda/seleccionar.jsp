...
<div style="margin-top: 60px; background-color: #FFF; margin-bottom: 10px">
    <br><h2 style="text-align: center;">Seleccione un Disco</h2>
     ...
     <% String list = request.getParameter("lista");
       if(list==null)
       {%>
            <div style="margin-left:  15px;"><a href="t_index_modificar.jsp"><h4>&laquo; Volver</h4></a></div> <hr>
       <%}
       else
       {%>
       <div style="margin-left:  15px;"><a href="t_listas_modificar.jsp?tipo=<%out.print(request.getParameter("tipo"));%>"><h4>&laquo; Volver atrás</h4></a></div> <hr>
     <%}%>     
                        ...
                        float precio = funcionesCanciones.getOne(dis.getUpc(), 0).getPrecio(); %>
                         <li>
                            ...
                            <div class="texto-tienda" style="text-align: left;" id="disco">         
                                <div>
                                    <button id="agregarItem" class="btn btn-info" onclick="modificar('<% out.print(dis.getUpc());%>')" style="float: left; margin-left: 30px; margin-top: 20px;" style="width: 50px; height: 50px; float: right;">Editar</button>
...
<script type="text/javascript">
    function modificar(upc){
        window.location.href = "d_modificar.jsp?upc=" + upc;
    }
</script>